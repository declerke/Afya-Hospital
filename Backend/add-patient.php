                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form id="add-patient-form">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Medical Issue <span class="text-danger">*</span></label>
                                        <textarea class="form-control" rows="3" id="medical_history" name="medical_history"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-patient-form').on('submit', function(e) {
                ...
                const medicalHistory = $('#medical_history').val().trim();
                ...
                if (!medicalHistory) {
                    alert('Medical Issue is required.');
                ...
                // Send AJAX request to add patient
                $.ajax({
                    url: 'add_patient.php',
                    type: 'POST',
                    data: formData,
                    ...
                    error: function(xhr, status, error) {
                        console.error('AJAX error for adding patient:', {
                            status: xhr.status,
                            statusText: xhr.statusText,
                            responseText: xhr.responseText,
                            error: error
                        });
                        alert('Error adding patient due to a server error: ' + error);
                    }
                });
            });
        });
