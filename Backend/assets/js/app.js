$(document).ready(function($) {
	...
	function init() {
		...
		var currentPage = window.location.pathname.split('/').pop() || 'admindashboard.php';
        ...
        success: function(response) {
            if (response.success && response.data) {
                ...
                if (userType === 'admin') {
                    ...
                    $('#edit-profile-btn').attr('href', 'edit-doctor.php?id=' + userId);
                }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                limitedAppointments.forEach(appointment => {
                    ...
                    // Appointment details page URL (e.g., appointments.php?id={appointment_id})
                    const detailsUrl = `appointments.php?id=${appointment.appointment_id}`;

                    html += `
                        <tr>
                            <td style="min-width: 200px;">
                                <a class="avatar" href="profile.php">${patientAvatar}</a>
                                <h2><a href="profile.php">${patientName} <span>${patientLocation}</span></a></h2>
                            </td>
                            <td>
...
$(document).ready(function() {
                        ...
                        <li>
                            <div class="contact-cont">
                                <div class="float-left user-img m-r-10">
                                    <a href="doctors.php?id=${doctor.id}" title="${doctor.full_name}">
    ...
    // Function to fetch and update doctors list on doctors.php
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-3" data-doctor-id="${doctor.id}">
                            <div class="profile-widget">
                                <div class="doctor-img">
                                    <a class="avatar" href="profile.php?type=doctor&id=${doctor.id}"><img alt="" src="${doctor.profile_pic || 'assets/img/default-avatar.jpg'}"></a>
                                </div>
                                <div class="dropdown profile-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="edit-doctor.php?id=${doctor.id}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                ...
                                <h4 class="doctor-name text-ellipsis"><a href="profile.php?type=doctor&id=${doctor.id}">${doctor.first_name} ${doctor.last_name}</a></h4>
    ...
    // Initial load for doctors.php
    if (window.location.pathname.includes('doctors.php')) {
    ...
    if (window.location.pathname.includes('edit-doctor.php')) {
        ...
        if (!doctorId) {
            ...
            window.location.href = 'doctors.php'; // Redirect if no ID
            return;
        }
                    ...
                    patientRows += `
                        <tr>
                            ...
                            <td class="condition-cell">
                                <a href="patients.php?id=${patient.id}" class="${buttonClass} float-right">${patient.medical_history}</a>
                            </td>
                        </tr>`;
                });
            }
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="dropdown dropdown-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="edit-patient.php?id=${patient.id}">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit-employee.php?id=${employee.id}&role=${employee.role}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
$(document).ready(function() {
    ...
    // Initial load and event handlers (only for dataaccesslogs.php)
    if (window.location.pathname.includes('dataaccesslogs.php')) {
        // Initial fetch
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit-user.php?id=${user.id}">
                                                <i class="fa fa-pencil m-r-5"></i> Edit
                                            </a>
...
// Notifications Table (for activities.php)
$(document).ready(function() {
